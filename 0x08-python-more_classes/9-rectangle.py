...
can print the rectangle using print_symbol with print() or str()
returns representation of the rectangle to be used by eval()
prints message when deleted
static method to compare and return the largest rectangle based on area
class method to return new Rectangle instance for a square"""
